...
export const MarkOrderReadyResponse = zod
  .object({
    id: zod.string(),
    externalOrderId: zod.string(),
    restaurantId: zod.string(),
 ...
 */
export const getRoleMigrationStatusResponseTotalUsersMin = 0;

export const getRoleMigrationStatusResponseUsersWithRoleRowsMin = 0;

export const getRoleMigrationStatusResponseUsersWithoutRoleRowsMin = 0;

export const getRoleMigrationStatusResponseLegacyUsersPendingMin = 0;

export const GetRoleMigrationStatusResponse = zod.object({
  totalUsers: zod.number().min(getRoleMigrationStatusResponseTotalUsersMin),
  usersWithRoleRows: zod
    .number()
    .min(getRoleMigrationStatusResponseUsersWithRoleRowsMin),
  usersWithoutRoleRows: zod
    .number()
    .min(getRoleMigrationStatusResponseUsersWithoutRoleRowsMin),
  legacyUsersPending: zod
    .number()
    .min(getRoleMigrationStatusResponseLegacyUsersPendingMin)
    .describe(
      "Accounts with no canonical role rows that can be initialized from users.role.",
    ),
  readyToRemoveLegacyRole: zod
    .boolean()
    .describe("True only when every account has at least one user_roles row."),
});
 ...
 */
export const initializeLegacyRolesResponseOneTotalUsersMin = 0;

export const initializeLegacyRolesResponseOneUsersWithRoleRowsMin = 0;

export const initializeLegacyRolesResponseOneUsersWithoutRoleRowsMin = 0;

export const initializeLegacyRolesResponseOneLegacyUsersPendingMin = 0;

export const initializeLegacyRolesResponseTwoInitializedUsersMin = 0;

export const initializeLegacyRolesResponseTwoInsertedRoleRowsMin = 0;

export const InitializeLegacyRolesResponse = zod
  .object({
    totalUsers: zod.number().min(initializeLegacyRolesResponseOneTotalUsersMin),
    usersWithRoleRows: zod
      .number()
      .min(initializeLegacyRolesResponseOneUsersWithRoleRowsMin),
    usersWithoutRoleRows: zod
      .number()
      .min(initializeLegacyRolesResponseOneUsersWithoutRoleRowsMin),
    legacyUsersPending: zod
      .number()
      .min(initializeLegacyRolesResponseOneLegacyUsersPendingMin)
      .describe(
        "Accounts with no canonical role rows that can be initialized from users.role.",
      ),
    readyToRemoveLegacyRole: zod
  ...
  .and(
    zod.object({
      initializedUsers: zod
        .number()
        .min(initializeLegacyRolesResponseTwoInitializedUsersMin),
      insertedRoleRows: zod
        .number()
        .min(initializeLegacyRolesResponseTwoInsertedRoleRowsMin),
    }),
  );
