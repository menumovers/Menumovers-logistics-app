...
export const STATUS_CLASS: Record<OrderStatus, string> = {
  ...
  rider_assigned: "bg-primary/12 text-primary border-primary/30",
  rider_accepted: "bg-primary/20 text-primary border-primary/50",
  en_route_to_restaurant: "bg-chart-2/15 text-chart-2 border-chart-2/40",
  arrived_at_restaurant: "bg-chart-2/25 text-chart-2 border-chart-2/50",
